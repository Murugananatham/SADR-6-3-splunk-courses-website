...
import { Download, MessageSquare,Calendar, Clock, Users, Video, Rocket, CreditCard,  LayoutList, Hourglass, HandCoins, CircleCheckBig, ChevronLeft } from "lucide-react"
        ...
        <section id="#" className="relative bg-gradient-to-b from-[#E8F5E9] to-white py-28 md:py-28 md:pb-40">
          ...
          <div className="container relative z-10 flex flex-col items-center text-center">
            ...
            <div className="inline-flex items-center bg-white px-4 py-2 rounded-full shadow-md">
              ...
              <span className="text-md font-medium text-yellow-700 dark:text-black tracking-tight">Batch starts from April 14</span>
            </div>
