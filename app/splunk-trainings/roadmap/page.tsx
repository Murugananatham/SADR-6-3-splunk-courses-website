          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-md overflow-hidden border border-gray-100 mb-8">
            <div className="p-6 md:p-8">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="bg-white p-4 rounded border border-gray-200 shadow-sm hover:border-green-200 transition-colors">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button className="bg-green-600 hover:bg-green-700 text-lg py-6 px-8 shadow-sm">Enroll Now</Button>
                <Button
                  variant="outline"
